...
export const testEmail = async (req, res) => {
    ...
    try {
        ...
        const dummyDescripcion = `Solicito el pago de la factura del siguiente servicio: <br> Servicio: PRUEBA <br> Organización: INTEGRA TEST <br> Localidad: OFICINA PRUEBA <br> Proveedor: PROVEEDOR TEST <br> Monto: $0.00 MXN <br> Hora: ${new Date().toISOString()}`;
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(78,115,223,0.13);">
          ...
          <tr>
            <td style="padding:36px 40px 24px;">
              ...
              <p style="margin:0 0 28px;font-size:15px;color:#555555;line-height:1.75;">${dummyDescripcion}</p>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="background-image:linear-gradient(135deg,#4e73df 0%,#224abe 100%);border-radius:8px;box-shadow:0 4px 12px rgba(78,115,223,0.4);">
                          <a href="https://integra.infrahub.services/integra/#!/servicios/subirPago/dummy-token"
